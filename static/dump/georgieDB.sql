...
-- Started on 2023-06-10 12:48:38
...
--
-- TOC entry 264 (class 1255 OID 32976)
...
--
-- TOC entry 3267 (class 2604 OID 24603)
...
--
-- TOC entry 3266 (class 2604 OID 24592)
...
--
-- TOC entry 3270 (class 2604 OID 24629)
...
--
-- TOC entry 3271 (class 2604 OID 24630)
...
--
-- TOC entry 3272 (class 2604 OID 24647)
...
--
-- TOC entry 3273 (class 2604 OID 24648)
...
--
-- TOC entry 3276 (class 2604 OID 24680)
...
--
-- TOC entry 3277 (class 2604 OID 24681)
...
--
-- TOC entry 3278 (class 2604 OID 24682)
...
--
-- TOC entry 3274 (class 2604 OID 24661)
...
--
-- TOC entry 3275 (class 2604 OID 24662)
...
--
-- TOC entry 3279 (class 2604 OID 24700)
...
--
-- TOC entry 3280 (class 2604 OID 24701)
...
--
-- TOC entry 3268 (class 2604 OID 24613)
...
--
-- TOC entry 3269 (class 2604 OID 24614)
...
--
-- TOC entry 3497 (class 0 OID 32956)
-- Dependencies: 242
...
--
-- TOC entry 3477 (class 0 OID 24600)
-- Dependencies: 219
-- Data for Name: attribut; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.attribut (id_attribut, nom_attribut) FROM stdin;
1	duree
2	langue
3	Sous-titre 1
4	Sous-titre 2
...
--
-- TOC entry 3475 (class 0 OID 24589)
-- Dependencies: 217
-- Data for Name: categorie; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.categorie (id_categorie, nom_categorie, pic) FROM stdin;
2	Livres	book.jpg
3	Goodies	cup02.jpg
1	dvd	losing.jpg
\.
...
--
-- TOC entry 3483 (class 0 OID 24626)
-- Dependencies: 225
-- Data for Name: client; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.client (id_client, nom_client, password, email_client, id_ville) FROM stdin;
1	Pithivier	password	pithivier@mail.com	1
\.


--
-- TOC entry 3486 (class 0 OID 24644)
-- Dependencies: 228
-- Data for Name: commande; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.commande (id_commande, prix_comm, statut, date_commande, id_client) FROM stdin;
2	12.99	f	2023-02-19	1
\.


--
-- TOC entry 3493 (class 0 OID 24677)
-- Dependencies: 235
-- Data for Name: detail; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.detail (id_detail, quantite, id_commande, id_produit) FROM stdin;
3	1	2	1
4	1	2	2
\.
...
--
-- TOC entry 3473 (class 0 OID 24578)
-- Dependencies: 215
...
--
-- TOC entry 3489 (class 0 OID 24658)
-- Dependencies: 231
-- Data for Name: produit; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.produit (id_produit, nom_produit, description, prix, photo, id_categorie) FROM stdin;
19	Tasse - "I don't believe the Government"	Tasse - citation de George Carlin "I don't believe anything the government tells me"	14.99	images/cup03.jpg	3
20	Tasse - "Freedom"	Tasse - citation de Geroge Carlin "I love the freedom we used to have"	14.99	images/cup04.jpg	3
3	Playin with your head	George Carlin HBO special - 1986 Beverly Theater (Los Angeles - California)	12.99	images/playin.jpg	1
4	What Am I doing in New Jersey ?	George Carlin HBO special - 1988 Au Park performing arts center (Union City , New Jersey)	12.99	images/jersey.jpg	1
2	Carlin at Carnegie	George Carlin  HBO special - 1982 au Carnegie hall (New York city)	12.99	images/carnegie.jpg	1
7	Back in town	George Carlin HBO special - 1996 au Beacon Theater (New York city)	12.99	images/town.jpg	1
6	Jammin in New-York	George Carlin HBO special : 1992 au Paramount Theater (Madison Square Garden, New York city)	12.99	images/jammin.jpg	1
8	George Carlin : 40 years of Comedy	George Carlin HBO special - 1997 au Wheeler Opera House (Aspen, Colorado)	10.99	images/forty.jpg	1
9	You are all diseased	George Carlin HBO special - 1999 au Beacon Theater (New York city)	12.99	images/diseased.jpg	1
10	Complaints and grievances	George Carlin HBO special - 2001 au Beacon Theater (New York city)	12.99	images/complaint.jpg	1
11	Life is worth losing	George Carlin HBO special - 2006 au Beacon Theater (New York city)	12.99	images/losing.jpg	1
12	It's bad for ya	George Carlin HBO special - 2008 au Wells Fargo center for the Arts (Santa Rosa, Californie)	12.99	images/bad.jpg	1
5	Doin it again	George Carlin HBO special : 1990 au State Theatre (New Brunswick, New Jersey)	12.99	images/again.webp	1
13	Brain droppings	Recueil de pensées, d'observations et d'humour sarcastique de l'humoriste George Carlin. Dans ce livre, Carlin aborde des sujets variés tels que la politique, la religion, la société et la vie quotidienne, tout en offrant des commentaires cyniques et perspicaces sur ces sujets. "Brain Droppings" est un livre divertissant et stimulant qui encourage les lecteurs à remettre en question leurs propres croyances et à penser de manière critique sur le monde qui les entoure.	18.99	images/drop.jpg\n	2
16	Last words	Le célèbre comédien américain, raconte sa vie et sa carrière, en offrant un regard introspectif sur sa personnalité et ses pensées. Le livre retrace les moments clés de la vie de Carlin, des débuts de sa carrière comique jusqu'à sa consécration en tant que légende du stand-up. À travers ses histoires et ses anecdotes, Carlin donne un aperçu de son processus créatif et de sa philosophie de vie.	18.99	images/words.jpg	2
17	Tasse : "don't sweat the petty things"	Tasse - citation de George Carlin "Don't sweat the petty things and don't pet the sweaty things"	14.99	Images/cup01.jpg	3
18	Tasse - "political correctness"	Tasse - citation de George Carlin "Political correctness is facism pretending to be manners"	14.99	images/cup02.jpg	3
1	George Carlin : Again !	George Carlin HBO special  - 1978 au Celibrity Theatre (Phoenix - Arizona)	12.99	images/again2.jpg	1
15	When will Jesus bring the pork chops ?	Dans ce Livre,  George Carlin, célèbre humoriste américain, offre un regard satirique sur la société contemporaine. À travers ses observations sur la politique, la religion, la technologie, la langue et bien d'autres sujets, Carlin met en lumière les absurdités et les hypocrisies de la vie moderne.	16.99	images/chops.jpg	2
14	Napalm & silly putty	Dans ce livre, Carlin aborde des sujets controversés tels que la religion, la politique, la culture populaire et les relations humaines, tout en y apportant son humour caustique et souvent provocateur. Ce livre est un recueil de pensées et de réflexions du célèbre comédien, qui se distingue par son style unique et son point de vue non conventionnel.	16.99	images/napalm.jpg	2
\.


--
-- TOC entry 3496 (class 0 OID 24697)
-- Dependencies: 238
-- Data for Name: produit_attributs; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.produit_attributs (id_produit, id_attribut, valeur) FROM stdin;
1	2	Anglais
1	3	Anglais
1	1	81
1	4	Français
...
12	4	Français
12	5	Néerlandais
13	6	978-0-7868-9112-2
13	7	272
14	6	978-0-7868-6413-3
14	7	272
15	6	978-1-4013-0134-7
15	7	300
16	6	1-4391-7295-1
16	7	320
17	8	335 ml
...
--
-- TOC entry 3480 (class 0 OID 24610)
-- Dependencies: 222
-- Data for Name: ville; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ville (id_ville, nom_ville, cp, id_pays) FROM stdin;
1	Mons	7000	1
2	Paris	75001	2
3	Berlin	10115	3
4	Bruxelles	1000	1
5	La louvière	7100	1
6	Cologne	50667	3
7	Madrid	28001	5
8	Carlin	\N	6
\.
...
--
-- TOC entry 3312 (class 2606 OID 32962)
...
--
-- TOC entry 3288 (class 2606 OID 24598)
...
--
-- TOC entry 3290 (class 2606 OID 24596)
...
--
-- TOC entry 3296 (class 2606 OID 24636)
...
--
-- TOC entry 3300 (class 2606 OID 24650)
...
--
-- TOC entry 3306 (class 2606 OID 24684)
...
--
-- TOC entry 3308 (class 2606 OID 24730)
...
--
-- TOC entry 3284 (class 2606 OID 24587)
...
--
-- TOC entry 3286 (class 2606 OID 24585)
...
--
-- TOC entry 3281 (class 2606 OID 24725)
...
--
-- TOC entry 3310 (class 2606 OID 24705)
...
--
-- TOC entry 3302 (class 2606 OID 24668)
...
--
-- TOC entry 3304 (class 2606 OID 24666)
...
--
-- TOC entry 3282 (class 2606 OID 24726)
...
--
-- TOC entry 3314 (class 2606 OID 24637)
...
--
-- TOC entry 3315 (class 2606 OID 24651)
...
--
-- TOC entry 3317 (class 2606 OID 24685)
...
--
-- TOC entry 3318 (class 2606 OID 24690)
...
--
-- TOC entry 3319 (class 2606 OID 24711)
...
--
-- TOC entry 3320 (class 2606 OID 24706)
...
--
-- TOC entry 3316 (class 2606 OID 24669)
...
--
-- TOC entry 3313 (class 2606 OID 24619)
...
-- Completed on 2023-06-10 12:48:39
